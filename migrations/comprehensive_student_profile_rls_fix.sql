-- Migration: Comprehensive Student Profile RLS Policy Fix
-- This migration provides a robust solution for student_profile permissions
-- using centralized functions for better maintainability and security
