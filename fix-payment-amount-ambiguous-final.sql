-- Fix for ambiguous payment_amount column reference in activate_student_account function
-- This script fixes the "column reference 'payment_amount' is ambiguous" error
...
-- Step 2: Create fixed activate_student_account function with explicit parameter references
